...
class StoreAttachmentRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'file_name' => 'required|string|max:255', // Ensure file_type is a string and not too long
    ...
    public  function getDataWithImage()
    {
        ...
        if ($this->hasFile('file_path')) 
        {
            ...
            $nameImage =  $data['file_name'].'.'. $this->file('file_path')->getClientOriginalExtension();
